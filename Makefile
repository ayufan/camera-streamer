...
LDLIBS += -L$(LIBDATACHANNEL_PATH) -ldatachannel-static
LDLIBS += -L$(LIBDATACHANNEL_PATH)/deps/usrsctp/usrsctplib -lusrsctp
LDLIBS += -L$(LIBDATACHANNEL_PATH)/deps/libsrtp -lsrtp2
LDLIBS += -L$(LIBDATACHANNEL_PATH)/deps/libjuice -ljuice-static
LDLIBS += -lcrypto -lssl

camera-streamer: $(LIBDATACHANNEL_PATH)/libdatachannel-static.a
endif
